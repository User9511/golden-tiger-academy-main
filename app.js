...
document.getElementById("wing-tsun").addEventListener("click", () => {
  filterClasses("wing-tsun");
});

document.getElementById("blood-and-bones").addEventListener("click", () => {
  filterClasses("blood-and-bones");
});
